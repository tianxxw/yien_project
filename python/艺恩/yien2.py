...
# 执行插入语句
sql="INSERT INTO yiendata2(Irank,MovieName,ReleaseTime,BoxOffice,BoxPercent,EnMovieID,ReleaseDays," \
...
url='https://ys.endata.cn/enlib-api/api/home/getrank_singlemonth.do?r=0.2163343224752321&top=50'
...
for item in data1:
    ...
    cursor.execute(sql,[str(Irank),MovieName,str(ReleaseTime),str(BoxOffice),str(BoxPercent),str(EnMovieID),
