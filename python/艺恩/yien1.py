...
# 执行插入语句
sql="INSERT INTO yiendata1(Irank,MovieName,InsertDate,BoxOffice,EnMovieID,ReleaseDays," \
    ...
    "DouBanScore,Movie_name,DefaultImage,ReleaseDate,PointDate,Country,Genre)VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s" \
    ",%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
heads={
    'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.63 Safari/537.36 Edg/102.0.1245.39'
}
url='https://ys.endata.cn/enlib-api/api/home/getrank_singleday.do?r=0.3961201405697212&top=50&type=1'
...
for item in data1:
    ...
    cursor.execute(sql,[str(Irank),MovieName,str(InsertDate),str(BoxOffice),str(EnMovieID),
