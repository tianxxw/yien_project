...
# 执行插入语句
sql="INSERT INTO yiendata4(Irank,MovieName,InsertDate,ShowCountPercent,ShowCount,ShowCount_Eff,EnMovieID,ReleaseDays," \
...
url='https://ys.endata.cn/enlib-api/api/home/getrank_showcountpercent.do?r=0.09319867791560754&top=50&type=1'
...
for item in data1:
    ...
    print(InsertDate)
    ShowCountPercent = item['ShowCountPercent']
    print(ShowCountPercent)
    ShowCount=item['ShowCount']
    print(ShowCount)
    ShowCount_Eff = item['ShowCount_Eff']
    print(ShowCount_Eff)
    ...
    cursor.execute(sql,[str(Irank),MovieName,str(InsertDate),str(ShowCountPercent),str(ShowCount),str(ShowCount_Eff),str(EnMovieID),
