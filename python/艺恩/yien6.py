...
# 执行插入语句
sql="INSERT INTO yiendata6(Irank,MovieName,ReleaseTime,WeekNum,SumBoxOffice,EnMovieID,ReleaseDays," \
...
url='https://ys.endata.cn/enlib-api/api/home/getrank_weekmorechampion.do?r=0.7160314835971995&top=50'
...
for item in data1:
    ...
    cursor.execute(sql,[str(Irank),MovieName,str(ReleaseTime),str(WeekNum),str(SumBoxOffice),str(EnMovieID),
