...
# 执行插入语句
sql="INSERT INTO yiendata8(Irank,Festival,StartDate,BoxOffice,MovieName,EnMovieID,ReleaseDays," \
...
url='https://ys.endata.cn/enlib-api/api/home/getrank_festival.do?r=0.8862594213225701&top=50&type=1'
...
for item in data1:
    ...
    cursor.execute(sql,[str(Irank),str(Festival),str(StartDate),str(BoxOffice),str(MovieName),str(EnMovieID),
