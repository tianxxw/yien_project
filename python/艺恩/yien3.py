...
# 执行插入语句
sql="INSERT INTO yiendata3(Irank,MovieName,ReleaseTime,ShowCount,ShowCountPercent,ShowCount_Eff,EnMovieID,ReleaseDays," \
...
url='https://ys.endata.cn/enlib-api/api/home/getrank_showcount.do?r=0.5489318584506839&top=50&type=1'
...
for item in data1:
    ...
    cursor.execute(sql,[str(Irank),MovieName,str(ReleaseTime),str(ShowCount),str(ShowCountPercent),str(ShowCount_Eff),str(EnMovieID),
