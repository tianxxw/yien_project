...
# 执行插入语句
sql="INSERT INTO yiendata(Irank,MovieName,ReleaseTime,BoxOffice,AvgBoxOffice,AvgAudienceCount,EnMovieID,ReleaseDays," \
    ...
    "DouBanScore,Movie_name,DefaultImage,ReleaseDate,PointDate,Country,Genre)VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s" \
    ",%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
heads={
    'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.63 Safari/537.36 Edg/102.0.1245.39'
}
url='https://ys.endata.cn/enlib-api/api/home/getrank_mainland.do?r=0.13612503740078763&top=50&type=0'
...
for item in data1:
    ...
    print(BoxOffice)
    AvgBoxOffice=item['AvgBoxOffice']
    print(AvgBoxOffice)
    AvgAudienceCount=item['AvgAudienceCount']
    print(AvgAudienceCount)
    ...
    cursor.execute(sql,[str(Irank),MovieName,str(ReleaseTime),str(BoxOffice),str(AvgBoxOffice),str(AvgAudienceCount),str(EnMovieID),
